...
public class BaseClient {
    ...
    protected <T> ResponseEntity<Object> post(String path, Long userId, Comment body) {
        return post(path, userId, null, body);
    }

    protected <T> ResponseEntity<Object> post(String path, Long userId, NewBookingRequest body) {
        return post(path, userId, null, body);
    }
    ...
    private <T> ResponseEntity<Object> makeAndSendRequest(HttpMethod method, String path, Long userId, @Nullable Map<String, Object> parameters, @Nullable T body) {
        System.out.println("DEBUG: path=" + path + ", userId=" + userId + ", parameters=" + parameters);
